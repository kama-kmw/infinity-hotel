        ...
        <div class="container">
            <div class="row">
                <div class="section-title col-lg-12">
                    <h2>3D тур по отелю</h2>
                    <div style="position:relative;overflow:hidden;"><a href="https://yandex.ru/maps?utm_medium=mapframe&utm_source=maps" style="color:#eee;font-size:12px;position:absolute;top:0px;">Яндекс Карты</a><a href="https://yandex.ru/maps/?ll=37.938699%2C44.656290&panorama%5Bdirection%5D=293.518188%2C-3.223383&panorama%5Bfull%5D=true&panorama%5Bpoint%5D=37.938699%2C44.656290&panorama%5Bspan%5D=112.358449%2C60.000000&utm_medium=mapframe&utm_source=maps&z=10" style="color:#eee;font-size:12px;position:absolute;top:14px;">Яндекс Карты — транспорт, навигация, поиск мест</a><iframe src="https://yandex.ru/map-widget/v1/?ll=37.938699%2C44.656290&panorama%5Bdirection%5D=293.518188%2C-3.223383&panorama%5Bfull%5D=true&panorama%5Bpoint%5D=37.938699%2C44.656290&panorama%5Bspan%5D=112.358449%2C60.000000&z=10" width="100%" height="460" frameborder="1" allowfullscreen="true" style="position:relative;"></iframe></div>
                </div>
            </div>
    ...
    <section class="homepage-about spad">
        <div class="container">
            <div class="about-text">
                <div class="section-title">
                    <h2>Что есть интересного рядом с нами?</h2>
                </div>
